...
<div class="crud__index-container">
  ...
  <div class="crud__index">
      <div class="crud__index-top">
           <form action="{{route('register')}}" method="GET"  class="crud__add">
              <button class="crud__add-btn">Add new user</button>
           </form>
      </div>
                                ...
                                <table class="crud_table">
                                    <thead class="crud-table-thead">
                                        ...
                                        <tr class="crud-table-row">
                                            ...
                                            <th class="crud-table-header">phone numb</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="crud-table-row">
                                            ...
                                            <td class="crud_table_cell">{{$item->email}} </td>
